...
HUMIDITY_SENSOR_ANALOG_PIN_INPUT = 2          # A0  - humidity sensor analog output
VENT_DC_MOTOR_DIGITAL_PIN_OUTPUT = 38          # D4  - DC motor (drive through a transistor/MOSFET!)
EXTERNAL_LED_DIGITAL_PIN_OUTPUT = 9           # D5  - external LED (use a series resistor)
VENT_SERVO_MOTOR_DIGITAL_PWM_PIN_OUTPUT = 21   # D6  - servo signal wire (PWM on a digital pin)
...
SERVO_ROTATION_AMOUNT_DEGREES = 45
...
HUMIDITY_MEASUREMENT_OUTPUT_THRESHOLD = 10000
